                ...
                <Character
                    ...
                    className={`
                        absolute z-20 transition-all duration-1000 origin-bottom
                                                    ${isWudu
                            ? /* Mobile: anchor to top so lower body is cropped; Desktop: keep bottom alignment */
                            `top-[6%] md:bottom-[8%] w-[22%] h-auto aspect-[0.6] ${status === 'success' ? 'md:left-[45%] left-[15%]' : 'left-[15%]'}`
                            : /* Non-Wudu: center on desktop, top-anchored on mobile */
                            `top-[6%] md:bottom-[8%] md:left-1/2 md:transform md:-translate-x-1/2 w-[32%] h-auto aspect-[0.6]`
                        }
                    `}
                />
